    ...
    <div className="min-h-screen flex flex-col md:flex-row font-inter bg-white">
      ...
      <section className="w-full md:w-1/2 lg:w-auto lg:min-w-96 flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-14 py-8 md:py-12 bg-white overflow-y-auto max-h-screen md:max-h-none">
        ...
        <p className="text-sm md:text-base text-gray-400 mb-6 md:mb-8">
          Sign up to get started with TaskPro.
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-5">
          ...
          <button
            type="submit"
            className="w-full py-2.5 md:py-3 bg-orange-400 text-white rounded-lg font-semibold transition hover:bg-orange-500 active:bg-orange-600 text-sm md:text-base mt-2"
          >
            Sign up
          </button>
        </form>
        ...
        <button
          type="button"
          onClick={() =>
            (window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/google/signup?redirect=${encodeURIComponent(
